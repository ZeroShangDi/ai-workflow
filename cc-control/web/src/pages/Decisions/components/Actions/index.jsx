...
export default function DecisionsActions({
  ...
  return (<> {approvable || overrideable ? <div className="review-actions">
      ...
      {adoptable && <Button disabled={busy} onClick={adopt}>采纳决策</Button>}
      {approvable && <Button disabled={busy || !reviewer.trim() || !instruction.trim()} onClick={alternative}>提交其他决策</Button>}
