...
好技能 = 专家才知道的那部分，减去 Claude 本来就会的
判断标准就一句话：删掉这句，任务还能不能完成？
...
------------- 议题：“长时间”“独立自主”生成“商业级”产品的问题点在哪里
- Coding 能力 ≠ Product Engineering
- 长链条可靠性
    - 0.99^200≈13.4%，实际开发中可能是数万次决策
- 它不知道“什么时候自己错了”
- 商业产品没有天然的 Ground Truth，不知道什么是对的
- Agent 很容易“局部最优”
- Context 不是“窗口大小”那么简单
    - 什么 context 是重要的？
    - 当前决策需要哪些 context？
    - Context Management / Memory / State Estimation
    - 一个能够持续构建、维护和更新“世界模型”的系统
- 长期项目需要“状态”，而现在 Agent 更多是在“对话”
    - Agent 必须拥有“持续存在的项目状态”
    - 我知道这个产品为什么这么设计、哪些决策已经被验证、哪些假设仍然未经验证、哪些技术债务存在、哪些模块不能动、哪些指标正在恶化。
- 缺乏真正的“自我验证闭环”
- Agent 不会真正承担“责任”
    - Knowing when NOT to act。知道什么时候不做。
    - 这个需求先不做/这个决策当前信息不足/需要用户确认/和现有逻辑冲突/风险收益不成正比


商业产品自动化能力：Verification + Persistent State + Objective Management
...
- 如何设计一个系统，让现在的 AI 即使还不像人，也能完成尽可能长的工程任务？
- 如何管理一群能力很强、但偶尔会犯低级错误的 AI 工程师？
- 如何给 AI 建立一个完整的信息—判断—行动闭环？
- 决策力 / 判断力 / 大局观


- 决策：标准，风险等级。
- 系统化、流程化、工具化、方法论化
- 信息-判断-决策-执行-结果？-局部正确整体错误-
